...
Java_com_snappwish_smarthotel_devicemodule_wakeup_WakeUpNative_wakeUpInitial(JNIEnv *env,
                                                                     jobject instance,
                                                                     jstring wakeUpWd_,
                                                                     jstring sFile_,
                                                                     jint mode) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_snappwish_smarthotel_devicemodule_wakeup_WakeUpNative_wakeUpReset(JNIEnv *env,
                                                                   jobject instance) {
    return WakeUpReset();
}
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_snappwish_smarthotel_devicemodule_wakeup_WakeUpNative_wakeUpDecode(JNIEnv *env,
                                                                    jobject instance,
                                                                    jshortArray data_,
                                                                    jint dataLen,
                                                                    jstring senArr_,
